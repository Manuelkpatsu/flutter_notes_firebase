...
import '../../../locator.dart';
import 'home_tile_bloc.dart';
import 'home_tile_event.dart';
import 'home_tile_model_data.dart';

class HomeTile extends StatelessWidget {
  late HomeTileBloc bloc;
  final eventController = StreamController<HomeTileEvent>();
  final HomeTileModelData _modelData;

  HomeTile(BuildContext context, this._modelData, {Key? key})
      : super(key: ValueKey(_modelData.id)) {
    bloc = get<HomeTileBloc>(param1: context, param2: eventController);
  }
